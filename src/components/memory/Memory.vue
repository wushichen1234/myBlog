<template>
  <div>
    <div class="memory-main">
      <!-- 首页左侧（主要内容）区域 -->
      <div class="memory-main-left">
        <div class="memory-main-left-item" @click="turnToDetail(item)" v-for="(item,i) in blogDetailList" :key="i">
          <div class="left">
    ...
    <Pagination :total="total" @memory="getCurrentPage"/>
  </div>
</template>
...
.memory-main-left {
  ...
  .memory-main-left-item:last-child {
    margin-bottom: 0;
  }

  .memory-main-left-item:hover {
    cursor: pointer;
  }
}
</style>