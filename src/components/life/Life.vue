  ...
  <div>
    <div class="life-main">
      ...
      <div class="life-main-left">
        <div class="life-main-left-item" @click="turnToDetail(item)" v-for="(item,i) in blogDetailList" :key="i">
          <div class="left">
    ...
    <Pagination :total="total" @life="getCurrentPage"/>
  </div>
</template>
...
.life-main-left {
  ...
  .life-main-left-item:last-child {
    margin-bottom: 0;
  }

  .life-main-left-item:hover {
    cursor: pointer;
  }
}
</style>